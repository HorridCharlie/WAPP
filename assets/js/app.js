...
let apiUrl = 'https://api.weatherapi.com/v1/current.json?key=44d7d6da42c9483d8a0165707231506&aqi=no&q='
...
let searchPosition = (positon) => {
    // console.log(positon)
    cityInput.value = `${positon.coords.latitude},${positon.coords.longitude}`
